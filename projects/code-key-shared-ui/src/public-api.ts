...
export * from './home-page/header/header.component';
export * from './home-page/service-section/service-section.component';
export * from './home-page/slider/slider.component';
export * from './home-page/vision/vision.component';
export * from './home-page/news/news.component';
export * from './home-page/sectors-section/sectors-section.component';
export * from './home-page/events-section/events-section.component';
export * from './home-page/logo-slider/logo-slider.component';
export * from './home-page/statistics-section/statistics-section.component';
export * from './home-page/contact-us/contact-us.component';
export * from './home-page/photo-slider/photo-slider.component'
export * from './home-page/footer/footer.component';
export * from './home-page/pages/about/about.component';
export * from './home-page/pages/faculties-programs/faculties-programs.component';
