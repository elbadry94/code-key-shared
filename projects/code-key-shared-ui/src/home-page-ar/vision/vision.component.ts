...
visionCards = [
  {
    ...
    colClass: 'col-md-6'   // 🟢 نصف العرض
  },
  {
    text: 'تحقيق التميز في البرامج الأكاديمية والمناهج الدراسية من خلال تطوير المناهج وتحديث البرامج الأكاديمية.',
    color: '#5b68b0',
